        ...
        <div className="space-y-6 animate-in fade-in-50 duration-500">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Lifetime enquiries received</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Enquiries to Quotes</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="grid gap-4 md:grid-cols-7">
                <Card className="col-span-4">
                    <CardHeader>
                        <CardTitle>Enquiry Activity Trend</CardTitle>
                    </CardHeader>
                        ...
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={stats.recentActivity}>
                                    ...
                                    />
                                    <Area type="monotone" dataKey="count" stroke="#635bff" fillOpacity={1} fill="url(#colorEnquiries)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
