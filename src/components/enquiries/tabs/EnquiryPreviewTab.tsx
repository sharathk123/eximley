...
import { FileDown, Upload, Loader2, AlertCircle, Info } from 'lucide-react';
import type { Enquiry } from '@/types/enquiry';

interface EnquiryPreviewTabProps {
    enquiry: Enquiry;
    pdfUrl: string | null;
    pdfLoading: boolean;
    pdfError: boolean;
...
export function EnquiryPreviewTab({
    enquiry,
    pdfUrl,
    pdfLoading,
    pdfError,
            ...
            <Card className="shadow-sm border-muted/40">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    <div>
                        ...
                        <CardDescription className="text-sm">View and export the enquiry PDF document</CardDescription>
                    </div>
