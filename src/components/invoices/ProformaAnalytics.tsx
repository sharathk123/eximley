...
import { Loader2, TrendingUp, DollarSign, FileCheck, CheckCircle2 } from 'lucide-react';
import {
...
export function ProformaAnalytics() {
    ...
    const fetchStats = async () => {
        try {
            const res = await fetch('/api/invoices/proforma/stats');
            if (res.ok) {
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Proforma invoices issued</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">To Export Orders</p>
                    </CardContent>
                </Card>
            </div>
                        ...
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={stats.recentActivity}>
                                    ...
                                    />
                                    <Area type="monotone" dataKey="amount" stroke="#a855f7" fillOpacity={1} fill="url(#colorProforma)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
