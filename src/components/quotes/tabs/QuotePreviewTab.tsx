...
interface QuotePreviewTabProps {
    quote: any;
    pdfUrl: string | null;
    pdfLoading: boolean;
    pdfError: boolean;
...
export function QuotePreviewTab({
    quote,
    pdfUrl,
    pdfLoading,
    pdfError,
            ...
            <Card className="shadow-sm border-muted/40">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    <div>
                        ...
                        <CardDescription className="text-sm">View and export the quote PDF document</CardDescription>
                    </div>
