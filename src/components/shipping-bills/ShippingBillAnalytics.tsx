...
export function ShippingBillAnalytics() {
    const [stats, setStats] = useState<ShippingBillStats | null>(null);
    ...
    const fetchStats = async () => {
        try {
            const res = await fetch('/api/shipping-bills/stats');
            if (res.ok) {
        ...
        <div className="space-y-6 animate-in fade-in-50 duration-500">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Shipping bills filed</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(stats.totalExportValue)}
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{(stats.statusCounts.filed || 0) + (stats.statusCounts.drafted || 0)}</div>
            ...
            <div className="grid gap-4 md:grid-cols-7">
                <Card className="col-span-4">
                    <CardHeader>
                        <CardTitle>Export Value Trend</CardTitle>
                    </CardHeader>
                        ...
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={stats.recentActivity}>
                                    ...
                                    />
                                    <Area type="monotone" dataKey="amount" stroke="#f59e0b" fillOpacity={1} fill="url(#colorExport)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
